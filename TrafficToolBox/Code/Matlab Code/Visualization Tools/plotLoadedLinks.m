function [handle_fig,handle_rect,handle_txt] = plotLoadedLinks(nodes,links,load,show_labels,fig_num,scale,maxLoad,title_figure)
...
if (nargin>7 && ~isempty(title_figure))
    title(title_figure);
end
